      ...
      <div class="content">
        <table>
          <tr>
            ...
            <td><input type="password" name="password" value="<?php echo $password; ?>" /><span class="required">(<font>*</font>)</span>
          ...
          <tr>
            ...
            <td><input type="password" name="confirm" value="<?php echo $confirm; ?>" /><span class="required">(<font>*</font>)</span>

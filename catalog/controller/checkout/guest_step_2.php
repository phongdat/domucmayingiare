  	...
  	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->session->data['comment'] = $this->request->post['comment'];
	  		...
	  		$this->redirect($this->model_tool_seo_url->rewrite($this->url->https('checkout/guest_step_3')));
    	} 
    	...
    	$this->data['action'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/guest_step_2'));
		...
		if ($this->config->get('config_checkout')) {
			...
			if ($information_info) {
				$this->data['text_agree'] = sprintf($this->language->get('text_agree'), $this->model_tool_seo_url->rewrite($this->url->http('information/information&information_id=' . $this->config->get('config_checkout'))), $information_info['title']);
			} else {
		...
		$this->data['back'] = $this->model_tool_seo_url->rewrite($this->url->http('checkout/guest_step_1'));

...
class ControllerCheckoutGuestStep3 extends Controller {
	public function index() {
		...
		if (!isset($this->session->data['guest'])) {
	  		$this->redirect($this->model_tool_seo_url->rewrite($this->url->https('checkout/guest_step_1')));
    	} 
		...
		$this->document->breadcrumbs = array();
      	...
      	$this->document->breadcrumbs[] = array(
        	'href'      => $this->model_tool_seo_url->rewrite($this->url->https('checkout/guest_step_2')),
        	'text'      => $this->language->get('text_guest_step_2'),
        	'separator' => $this->language->get('text_separator')
      	);

      	$this->document->breadcrumbs[] = array(
        	'href'      => $this->model_tool_seo_url->rewrite($this->url->https('checkout/guest_step_3')),
    	...
    	$this->data['checkout_shipping'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/guest_step_2'));

    	$this->data['checkout_shipping_address'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/guest_step_1'));
    	...
    	$this->data['checkout_payment'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/guest_step_2'));

    	$this->data['checkout_payment_address'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/guest_step_1'));

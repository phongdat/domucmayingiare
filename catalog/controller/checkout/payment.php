	...
	private $error = array();
  	...
  	public function index() {
    	...
    	if (!$this->session->data['payment_address_id']) {
	  		$this->redirect($this->model_tool_seo_url->rewrite($this->url->https('checkout/address/payment')));
    	}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->session->data['payment_method'] = $this->session->data['payment_methods'][$this->request->post['payment_method']];
	  		...
	  		$this->redirect($this->model_tool_seo_url->rewrite($this->url->https('checkout/confirm')));
    	}
    	...
    	$this->data['action'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/payment'));
		...
		$this->data['change_address'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/address/payment'));
    	...
    	if ($this->cart->hasShipping()) {
      		$this->data['back'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/shipping'));
    	} else {
      		$this->data['back'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/cart'));
    	}

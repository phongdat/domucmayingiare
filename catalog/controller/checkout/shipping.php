	...
	private $error = array();
  	...
  	public function index() {
    	...
    	if (!$this->session->data['shipping_address_id']) {
	  		$this->redirect($this->model_tool_seo_url->rewrite($this->url->https('checkout/address/shipping')));
		}
		...
		$this->data['action'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/shipping'));
		...
		$replace = array(
	  		'customername'  => $shipping_address['customername'],
		...
		$this->data['change_address'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/address/shipping')); 

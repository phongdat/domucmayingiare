...
class ControllerCheckoutConfirm extends Controller { 
	public function index() {
    	...
    	$this->data['checkout_shipping'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/shipping'));

    	$this->data['checkout_shipping_address'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/address/shipping'));
    	...
    	$this->data['checkout_payment'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/payment'));

    	$this->data['checkout_payment_address'] = $this->model_tool_seo_url->rewrite($this->url->https('checkout/address/payment'));

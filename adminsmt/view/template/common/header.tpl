...
<body>
<div id="header">
  <div class="div1"><a href="<?php echo $home; ?>"><?php echo $heading_title; ?></a></div>
  <?php if ($logged) { ?>
  ...
  <ul class="nav left" style="display: none;">
    ...
    <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
      <ul>
		...
		<li><a href="index.php?route=catalog/chome">Danh mục trang chủ</a></li>
    ...
    <li id="information"><a class="top"><?php echo $text_information; ?></a>
      <ul>
		<li><a href="index.php?route=catalog/cinformation">Danh mục <?php echo $text_information; ?></a></li>
		<li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>
      </ul>
    </li>
    <li id="news"><a class="top">Tin tức</a>
      <ul>
		<li><a href="index.php?route=news/cnews">Danh mục tin tức</a></li>
		<li><a href="index.php?route=news/news">Tin tức</a></li>
      </ul>
    </li>
    <li id="danhmuchotro"><a class="top">Hỗ trợ</a>
      <ul>
		<li><a href="index.php?route=catalog/csupport">Danh mục hỗ trợ</a></li>
		<li><a href="index.php?route=catalog/support">Hỗ trợ trực tuyến</a></li>
      </ul>
    </li>
    <li id="extension"><a class="top"><?php echo $text_extension; ?></a>
      <ul>
        <li><a href="<?php echo $module; ?>"><?php echo $text_module; ?></a></li>
		<li><a href="index.php?route=catalog/slideshow">Slideshow</a></li>

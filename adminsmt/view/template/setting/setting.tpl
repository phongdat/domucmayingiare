...
<div class="box">
  ...
  <div class="content">
    <div id="tabs" class="tabs"><a tab="#tab_shop"><?php echo $tab_shop; ?></a><a tab="#tab_product"><?php echo $tab_product; ?></a><a tab="#tab_local"><?php echo $tab_local; ?></a><a tab="#tab_option"><?php echo $tab_option; ?></a><a tab="#tab_image"><?php echo $tab_image; ?></a><a tab="#tab_mail"><?php echo $tab_mail; ?></a><a tab="#tab_server"><?php echo $tab_server; ?></a></div>
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <div id="tab_shop">
        <table class="form">
          ...
          <tr>
            <td><span class="required">*</span> <?php echo $entry_hotline; ?></td>
            <td><input type="text" name="config_hotline" value="<?php echo $config_hotline; ?>" />
              <?php if ($error_hotline) { ?>
              <span class="error"><?php echo $error_hotline; ?></span>
              <?php } ?></td>
          </tr>
          <tr>
        ...
        <div id="language<?php echo $language['language_id']; ?>">
          <table class="form">
            <tr>
              ...
              <td><textarea name="config_welcome_<?php echo $language['language_id']; ?>" id="welcome<?php echo $language['language_id']; ?>"><?php echo ${'config_welcome_' . $language['language_id']}; ?></textarea></td>
            </tr>            
			<tr>              
			  <td><?php echo $entry_contact; ?></td>              
			  <td><textarea name="config_lienhe_<?php echo $language['language_id']; ?>" id="lienhe<?php echo $language['language_id']; ?>"><?php echo ${'config_lienhe_' . $language['language_id']}; ?></textarea></td>            
			</tr>
          </table>
        </div>
        <?php } ?>
     ...
     <div id="tab_product">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="config_category" value="<?php echo $config_category; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_manufacturer; ?></td>
            <td><input type="text" name="config_manufacturer" value="<?php echo $config_manufacturer; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_search; ?></td>
            <td><input type="text" name="config_search" value="<?php echo $config_search; ?>" /></td>
          </tr>
		  <tr>
            <td><?php echo $entry_related; ?></td>
            <td><input type="text" name="config_related" value="<?php echo $config_related; ?>" /></td>
          </tr>
		  <tr>
            <td><?php echo $entry_special; ?></td>
            <td><input type="text" name="config_special" value="<?php echo $config_special; ?>" /></td>
          </tr>
		</table>
	</div>
      <div id="tab_local">
...
<?php foreach ($languages as $language) { ?>
CKEDITOR.replace('welcome<?php echo $language['language_id']; ?>');
CKEDITOR.replace('lienhe<?php echo $language['language_id']; ?>');
<?php } ?>	
//--></script>

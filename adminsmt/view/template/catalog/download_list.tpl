      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="left"><?php if ($sort == 'dd.name') { ?>
              ...
              <?php } ?></td>
            <td class="right"><?php echo $entry_filename; ?></td>
			<td class="right">Link download</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="right"><?php echo $download['filename']; ?></td>
			<td class="right"><a href="<?php echo $base; ?>download/<?php echo $download['filename']; ?>"><?php echo $base; ?>download/<?php echo $download['filename']; ?></a></td>

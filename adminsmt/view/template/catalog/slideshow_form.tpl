...
<div class="box">
  ...
  <div class="right"></div>
  <div class="heading">
    <h1 style="background: url('view/image/slideshow.png') 2px 9px no-repeat;"><?php echo $heading_title; ?></h1>
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <div id="language<?php echo $language['language_id']; ?>">
        <table class="form">
          <tr>
            <td><span class="required">*</span> Tên Slideshow</td>
            <td><input size="40"  name="slideshow_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($slideshow_description[$language['language_id']]) ? $slideshow_description[$language['language_id']]['name'] : ''; ?>" />

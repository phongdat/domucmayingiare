      ...
      <table class="form">
        <tr>
		  ...
		  <td><select name="cshow">
			...
			<option value="footer"<?php if($cshow=="footer") { echo ' selected="selected"'; } ?>>Footer</option>
			<option value="sidebar"<?php if($cshow=="sidebar") { echo ' selected="selected"'; } ?>>Sidebar</option>
		  </select></td>
        </tr>
        <tr>

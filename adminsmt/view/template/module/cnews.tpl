    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
          ...
          <td><input type="text" name="cnews_sort_order" value="<?php echo $cnews_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>

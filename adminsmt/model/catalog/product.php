...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		foreach ($data['product_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_description SET product_id = '" . (int)$product_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', description = '" . $this->db->escape($value['description']) . "', brief_description = '" . $this->db->escape($value['brief_description']) . "', technical_description = '" . $this->db->escape($value['technical_description']) . "', promotion = '" . $this->db->escape($value['promotion']) . "', tags = '" . $this->db->escape($value['tags'])  . "'");
		}
	...
	public function getTotalProductsBydanhmuchomeId($chome_id) {

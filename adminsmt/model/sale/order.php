...
class ModelSaleOrder extends Model {
	public function editOrder($order_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET order_status_id = '" . (int)$data['order_status_id'] . "', date_modified = NOW() WHERE order_id = '" . (int)$order_id . "'");
      	...
      	if (isset($data['notify'])) {
			...
			$mail->AddReplyTo($query->row['email']);
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, o.customername AS name, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS status, o.date_added, o.total, o.currency, o.value FROM `" . DB_PREFIX . "order` o";
		...
		if (isset($data['filter_name']) && !is_null($data['filter_name'])) {
			$sql .= " AND o.customername LIKE '%" . $this->db->escape($data['filter_name']) . "%'";
		}
	...
	public function getTotalOrders($data = array()) {
		...
		if (isset($data['filter_name']) && !is_null($data['filter_name'])) {
			$sql .= " AND customername LIKE '%" . $this->db->escape($data['filter_name']) . "%'";
		}

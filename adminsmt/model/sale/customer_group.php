...
class ModelSaleCustomerGroup extends Model {
	public function addCustomerGroup($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer_group SET name = '" . $this->db->escape($data['name']) . "', cg_status = '" . $this->db->escape($data['cg_status']) . "'");
	}
	
	public function editCustomerGroup($customer_group_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "customer_group SET name = '" . $this->db->escape($data['name']) . "', cg_status = '" . $this->db->escape($data['cg_status']) . "' WHERE customer_group_id = '" . (int)$customer_group_id . "'");
	}

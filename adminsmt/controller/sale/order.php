		...
		foreach ($orders as $order_id) {
			...
			$this->data['payment_method'] = $order_info['payment_method'];
				...
				$this->data['orders'][] = array(
					...
					'store'            => $this->config->get('config_store_' . $this->config->get('config_language_id')),
					'address'          => nl2br($this->config->get('config_address_' . $this->config->get('config_language_id'))),

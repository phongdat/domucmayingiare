...
class ControllerSettingSetting extends Controller {
	...
	public function index() { 
		...
		$this->data['entry_hotline'] = $this->language->get('entry_hotline');
		...
		if (isset($this->error['hotline'])) {
			$this->data['error_hotline'] = $this->error['hotline'];
		} else {
			$this->data['error_hotline'] = '';
		}
		...
		foreach ($languages as $language) {
			...
			if (isset($this->request->post['config_lienhe_' . $language['language_id']])) {
				$this->data['config_lienhe_' . $language['language_id']] = $this->request->post['config_lienhe_' . $language['language_id']];
			} else {
				$this->data['config_lienhe_' . $language['language_id']] = $this->config->get('config_lienhe_' . $language['language_id']);
			}
		}
		...
		if (isset($this->request->post['config_category'])) {
			$this->data['config_category'] = $this->request->post['config_category'];
		} else {
			$this->data['config_category'] = $this->config->get('config_category');
		}
		...
		if (isset($this->request->post['config_search'])) {
			$this->data['config_search'] = $this->request->post['config_search'];
		} else {
			$this->data['config_search'] = $this->config->get('config_search');
		}
		
		if (isset($this->request->post['config_related'])) {
			$this->data['config_related'] = $this->request->post['config_related'];
		} else {
			$this->data['config_related'] = $this->config->get('config_related');
		}
		
		if (isset($this->request->post['config_special'])) {
			$this->data['config_special'] = $this->request->post['config_special'];
		} else {
			$this->data['config_special'] = $this->config->get('config_special');
		}
	...
	private function validate() {
    	...
    	if ((strlen(utf8_decode($this->request->post['config_hotline'])) < 3) || (strlen(utf8_decode($this->request->post['config_hotline'])) > 32)) {
